...
onready var spr_sonic = $Characters/Sonic
onready var spr_tails = $Characters/Tails
...
var tails_tired : bool

var player_ch : int = 0
var tails_flight_time : int = 480

func _ready():
	if player_ch == 0:
		animation = $Characters/Sonic/AnimationPlayer
		spr_sonic.show()
		spr_tails.hide()
	elif player_ch == 1:
		animation = $Characters/Tails/AnimationPlayer
		spr_sonic.hide()
		spr_tails.show()
	elif player_ch == 2:
		pass # Knuckles not implemented yet
