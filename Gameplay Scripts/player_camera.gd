...
export(float) var LEFT = -16.0
export(float) var RIGHT = .0
export(float) var GROUND_TOP = .0
export(float) var GROUND_BOTTOM = .0
export(float) var AIR_TOP = 48.0
export(float) var AIR_BOTTOM = -16.0

export(float) var SCROLL_UP = -104.0
export(float) var SCROLL_DOWN = 88.0
export(float) var SCROLL_SPEED = 120.0
export(float) var SCROLL_DELAY = 2.0
